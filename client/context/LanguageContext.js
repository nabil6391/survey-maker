...
export const content = {
    ...
    bm: {
        ...
        about_study_desc: 'Anda dijemput untuk mengambil bahagian dalam kaji selidik dalam talian aplikasi web mengenai Pengukuran Dimensi Manusia Tidak Ketara Askar yang Menuju Ke Arah Kesediaan Iklim Komando Tentera yang dijalankan oleh Universiti Pertahanan Nasional Malaysia (UPNM). Ini adalah  sebuah projek penyelidikan yang sedang dijalankan untuk mengkaji dimensi manusia tidak ketara tentera. Untuk tujuan ini, kami amat menghargai jika anda boleh menjawab soal selidik berikut yang berkaitan dengan semangat, kualiti hidup dan faktor psikologi. Ia mengambil masa kira-kira 20-30 minit untuk disiapkan. Kementerian Pendidikan Malaysia (KPM) telah membiayai kajian ini di bawah Skim Geran Penyelidikan Fundamental (FRGS/1/2019/SS03/UPNM/02/2).        ',
        confidentiality_desc: 'Kami ingin memberi jaminan bahawa jawapan anda akan dianggap sebagai tertutup dan SULIT dan hanya akan digunakan untuk kajian akademik ini. Kami mengucapkan ribuan terima kasih kerana menjawab soal selidik kami walaupun beban kerja anda yang padat.',
        consent: 'PERSETUJUAN ELEKTRONIK: Sila pilih pilihan anda di bawah. Mengklik pada butang',
        agree_read_info: 'Anda telah membaca maklumat di atas. ',
        agree_voluntary: 'Anda secara sukarela bersetuju untuk mengambil bahagian.',
        project_leader: 'Ketua Projek: ',
        name_researchers: 'Nama penyelidik bersama',
        name_uni: 'National Defence University of Malaysia, Sg Besi Camp hasanalbanna@upnm.edu.my',
